...
if(!illegalChar(document.form1.account.value)||!illegalChar(document.form1.password.value)){
	window.alert("不要输入非法字符");
	return false;
}
...
function isNumberOr_Letter( s ){//判断是否是数字或字母 或下划线
...
function isChinaOrNumbOrLett( s ){//判断是否是汉字、字母、数字、下划线组成 
...
if(!isChinaOrNumbOrLett(document.form.account.value)){
	window.alert("用户名只能包括汉字、字母、数字、下划线！");
	return false;
}
...
if(!isNumberOr_Letter(document.form.repeatPassword.value)){
	window.alert("密码只能包括字母、数字、下划线");
	return false;
}
if(document.form.repeatPassword.value.length<6||document.form.repeatPassword.value.length>8){
	window.alert("密码为6-8位");
	return false;
}
...
function addPhoto(){   //评论添加
if(document.form.photoAddress.value==""){
window.alert("请选择上传的相片！");
return false;
}
if(document.form.photoDescription.value==""){
window.alert("请输入相片的描述信息！");
return false;
}
return true;
}

function addVideo(){   //评论添加
	if(document.form.videoAddress.value==""){
	window.alert("请选择上传的影音！");
	return false;
	}
	if(document.form.videoDescription.value==""){
	window.alert("请输入影音的描述信息！");
	return false;
	}
	return true;
	}
...
window.alert("此用户名不允许");return false;
}
