...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<%
out.println("<br><p align=left>&nbsp;&nbsp;&nbsp;&nbsp;<img src=images/icon.gif width=10 height=10>&nbsp;&nbsp;查询所有的影音</p>");
%>
        ...
        <td width="166"><div align="center">
            <table width="160" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
               ...
               <tr>
                      <td height="20"><div align="left"><a href="head_VideoForm.jsp?method=1&id=<%=VideoForm.getId()%>">评论>>></a></div></td>
              </tr>
            </table>
        </div></td>
        <%}else{%>
