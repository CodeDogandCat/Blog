...
<table width="800" height="65" border="0" align="center" cellpadding="0" cellspacing="0" background="images/back_noword_01.jpg">
  <tr>
    <td width="501">&nbsp;</td>
    <td width="299"><p>&nbsp;</p>
    <p><a href="head_main.jsp" class="backTop"><font color="#FFCC00">我的首页</font></a>&nbsp;<font color="#FFCC00">|</font>&nbsp; <a href="backMainPage.jsp" class="backTop"><font color="#FFCC00">管理博客</font></a>&nbsp;<font color="#FFCC00">|</font>&nbsp; <a href="dealwith.jsp?sign=2"" class="backTop"><font color="#FFCC00">安全退出</font></a></p></td>
  </tr>
</table>
