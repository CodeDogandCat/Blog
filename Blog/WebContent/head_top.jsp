  ...
  <tr>
    ...
    <td width="640"><table width="619" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="220"><span class="style3 style2">性别：<%=consumerHostForm.getSex()%></span></td>
        <td width="200"><span class="style3 style2">兴趣：<%=consumerHostForm.getInterest()%></span></td>
      </tr>
      <tr>
        <td height="20"><span class="style3 style2">QQ：<%=consumerHostForm.getQQNumber()%></span></td>
...
<table width="800" height="26" border="0" align="center" cellpadding="0" cellspacing="0" background="images/head_05.jpg">
  <tr>
    ...
    <td width="626">
            ...
            <span class="style4 style1">欢迎您光临我的博客,如果您对我发布的文章有看法,请对该文章进行回复.</span>
      </marquee>	</td>
    <td width="137">&nbsp;</td>
  </tr>
</table>
