...
<%LinkForm form=(LinkForm)request.getAttribute("form");%>
    ...
    <td width="573" valign="top"><table width="227" border="0" cellpadding="0" cellspacing="0">
      ...
      <table width="573" border="0" cellpadding="0" cellspacing="0" background="images/back_noword_05.jpg">
        <tr>
		  ...
		  <%out.println("<p align=left>&nbsp;&nbsp;&nbsp;&nbsp;<img src=images/icon.gif width=10 height=10>&nbsp;&nbsp;友情链接修改</p>");%>
		  <form name="form" method="post" action="LinkServlet?method=3&id=<%=form.getId()%>" onSubmit="return linkAdd()">
            ...
            <br>
 <input type="image" class="inputinputinput" src="images/modify.gif" width="51" height="20">
&nbsp;&nbsp;
