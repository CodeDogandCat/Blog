            ...
            <table width="340" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#FECE62">
              <tr>
                ...
                <td width="250" bgcolor="#FFFFFF"><div align="center">
                  <input name="discussTitle" type="text" class="inputinput" size="30">
                </div></td>
              </tr>
              <tr>
                <td height="30"><div align="center">推荐内容：</div></td>
                <td bgcolor="#FFFFFF"><div align="center">
                  <textarea name="discussContent" cols="28" rows="20" class="inputinput"></textarea>
</div></td>
              </tr>
			               <tr>
                <td height="30"><div align="center">发布时间：</div></td>
                <td bgcolor="#FFFFFF"><div align="center">
                  <input name="discussTime" type="text" class="inputinput" value="<%=countTime.currentlyTime() %>" size="30" readonly="readonly" onclick="alert('此文本框已设为只读，用户不能修改')">
                 </div></td>
              </tr>
