...
/*     */extends HttpServlet
/*     */{
	/* 18 */private ConsumerDao consumerDao = null;
	/*     */private int method;
	...
	/*     */{
		...
		/* 58 */form.setName(Chinese.toChinese(request.getParameter("name")));
		/* 59 */form.setSex(Chinese.toChinese(request.getParameter("sex")));
		/* 60 */form.setQQNumber(request.getParameter("QQnumber"));
		/* 61 */form.setMainPage(request.getParameter("mainPage"));
		/* 62 */form.setInterest(Chinese.toChinese(request.getParameter("interest")));
	...
	/*     */{
		...
		/* 81 */form.setName(Chinese.toChinese(request.getParameter("name")));
		/* 82 */form.setSex(Chinese.toChinese(request.getParameter("sex")));
		/* 83 */form.setQQNumber(request.getParameter("QQnumber"));
		/* 84 */form.setMainPage(request.getParameter("mainPage"));
		/* 85 */form.setInterest(Chinese.toChinese(request.getParameter("interest")));
		/* 86 */form.setEMail(request.getParameter("eMail"));
		/* 87 */form.setManageLevel("高级");
		/* 88 */String result = "修改博主信息失败！";
		/*     */
	...
	/*     */{
		...
		/* 148 */form.setName(Chinese.toChinese(request.getParameter("name")));
		/* 149 */form.setSex(Chinese.toChinese(request.getParameter("sex")));
		/* 150 */form.setQQNumber(request.getParameter("QQnumber"));
		/* 151 */form.setMainPage(request.getParameter("mainPage"));
		/* 152 */form.setInterest(Chinese.toChinese(request.getParameter("interest")));
	...
	/*     */{
		...
		/* 173 */String account = Chinese.toChinese(request.getParameter("account"));
		System.out.println("输入的账户名为" + account);
